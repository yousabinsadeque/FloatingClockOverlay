...
#ifndef FLOATINGCLOCKOVERLAY_SWIFT_H
#define FLOATINGCLOCKOVERLAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FloatingClockOverlay",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
@class NSMenu;
SWIFT_CLASS("_TtC20FloatingClockOverlay11AppDelegate")
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC20FloatingClockOverlay21ClockWindowController")
@interface ClockWindowController : NSWindowController <NSWindowDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC20FloatingClockOverlay24SettingsWindowController")
